...
interface ILiquidity{
  ...
  // 
  // -> function getOutputAmount(uint256 inputAmount, uint256 x, uint256 y) external pure returns (uint256);
  // 기본 기능 구현 후 아래 진행 예정
  // (uint256 liquidity, uint256 tokenAmount, uint256 coinAmount); 
